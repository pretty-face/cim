...
<div class="topBar">
  ...
  <div class="titleMenu">
    ...
    <el-dropdown @command="itemClick">
      <span class="btnStyle" style="margin-right:20px;margin-left:30px;">{{this.$store.state.user.user}}</span>
...
export default {
  ...
  mounted() {
    ...
    // let stateName = this.$store.state.login.userName;
    // if (stateName != "　") {
    //   this.name = stateName;
    // } else {
    //   this.name = localName;
