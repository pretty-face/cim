        ...
        <div class="login-form-wrapper" v-show="show">
            ...
            <el-form :model="loginForm" status-icon :rules="rules" ref="loginForm" label-width="100px" class="rule-form">
                ...
                <el-form-item prop="pass">
                    <el-input type="password" prefix-icon="el-icon-bell"  placeholder="登录密码" v-model="loginForm.pass" auto-complete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button style="width:370px" type="primary" @keyup.enter.native="submitForm" @click="submitForm('loginForm')">登录</el-button>
                </el-form-item>        
            </el-form>
